...
function convertTsunamiValue(text: string) {
    if (text == "None") return "津波の心配はありません";
    else if (text == "Checking") return "調査中";
    else if (text == "NonEffective") return "若干の海面変動が予想されますが、被害の心配はありません";
    else if (text == "Watch") return "現在津波注意報が発表されています";
    else if (text == "Warning") return "津波情報が発表されています";
    else return "不明";
}
